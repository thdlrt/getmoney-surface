...
export function getnews(page) {
  return axios.post("/api/api/news/index", {
    page: page,
  });
}
//获取热门股票
export function gethot() {
  return axios.get("/api/api/stock/gethot")
}
//搜索股票
export function search(name) {
  return axios.post("/api/api/stock/search", {
    name: name,
  });
}
//获取用户自选
export function getchoice() {
  return axios.get("/api/api/stock/getchoice")
}
//增加选择
export function addchoice(name, code) {
  return axios.post("/api/api/stock/addchoice", {
    name: name,
    code: code,
  });
}
//删除自选
export function delchoice(name, code) {
  return axios.post("/api/api/stock/delchoice", {
    name: name,
    code: code,
  });
}
//获取股票信息
export function getstock(name, code) {
  return axios.post("/api/api/stock/getstock", {
    name: name,
    code: code,
  })
}
//获取股票分时信息
export function getstockh(name, code) {
  return axios.post("/api/api/stock/getstockh",{
      name:name,
      code:code,
  })
  // return {
...
//获取股票k线信息
export function getstockk(month, code, frequency) {
  return axios.post("/api/api/stock/getstockk", {
    month: month,
    code: code,
    frequency: frequency
  })
